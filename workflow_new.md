...
```bash
python data_preparation/prepare_strawberry_sdf.py --src /home/tianqi/corepp2/data/20260301_dataset
```
...
```bash
python data_preparation/make_strawberry_splits.py --data_dir /home/tianqi/corepp2/data/20260301_dataset
```
